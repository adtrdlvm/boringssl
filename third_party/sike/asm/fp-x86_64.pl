...
.cfi_offset r14, -32
  ...
  mov  0x0(%rdi),  %r8;  add  0x0(%rsi),  %r8
  mov  0x8(%rdi),  %r9;  adc  0x8(%rsi),  %r9
  mov 0x10(%rdi), %r10;  adc 0x10(%rsi), %r10
  mov 0x18(%rdi), %r11;  adc 0x18(%rsi), %r11
  mov 0x20(%rdi), %r12;  adc 0x20(%rsi), %r12
  mov 0x28(%rdi), %r13;  adc 0x28(%rsi), %r13
  mov 0x30(%rdi), %r14;  adc 0x30(%rsi), %r14

  mov      .Lp434x2(%rip), %rcx;  sub %rcx, %r8
  mov  0x8+.Lp434x2(%rip), %rcx;  sbb %rcx, %r9
                                  sbb %rcx, %r10
  mov 0x10+.Lp434x2(%rip), %rcx;  sbb %rcx, %r11
  mov 0x18+.Lp434x2(%rip), %rcx;  sbb %rcx, %r12
  mov 0x20+.Lp434x2(%rip), %rcx;  sbb %rcx, %r13
  mov 0x28+.Lp434x2(%rip), %rcx;  sbb %rcx, %r14

  sbb \$0, %rax

  mov      .Lp434x2(%rip), %rdi;  and %rax, %rdi
  mov  0x8+.Lp434x2(%rip), %rsi;  and %rax, %rsi
  mov 0x10+.Lp434x2(%rip), %rcx;  and %rax, %rcx

  add %rdi,  %r8;  mov %r8,   0x0(%rdx)
  adc %rsi,  %r9;  mov %r9,   0x8(%rdx)
  adc %rsi, %r10;  mov %r10, 0x10(%rdx)
  adc %rcx, %r11;  mov %r11, 0x18(%rdx)

  setc %cl
  mov 0x18+.Lp434x2(%rip),  %r8;  and %rax,  %r8
  mov 0x20+.Lp434x2(%rip),  %r9;  and %rax,  %r9
  mov 0x28+.Lp434x2(%rip), %r10;  and %rax, %r10
  bt \$0, %rcx

  adc  %r8, %r12;  mov %r12, 0x20(%rdx)
  adc  %r9, %r13;  mov %r13, 0x28(%rdx)
  adc %r10, %r14;  mov %r14, 0x30(%rdx)
...
.cfi_offset r14, -32
  ...
  mov  0x0(%rdi),  %r8;  sub  0x0(%rsi),  %r8
  mov  0x8(%rdi),  %r9;  sbb  0x8(%rsi),  %r9
  mov 0x10(%rdi), %r10;  sbb 0x10(%rsi), %r10
  mov 0x18(%rdi), %r11;  sbb 0x18(%rsi), %r11
  mov 0x20(%rdi), %r12;  sbb 0x20(%rsi), %r12
  mov 0x28(%rdi), %r13;  sbb 0x28(%rsi), %r13
  mov 0x30(%rdi), %r14;  sbb 0x30(%rsi), %r14
...
sub rdc_mulx {
  ...
  my $mul01=&mul128x256_school(0,"rdi",".Lp434p1(%rip)",map("r$_",(8..13)),"rcx");
  # a[2-3] x .Lp434p1 --> result: r8:r13
  my $mul23=&mul128x256_school(16,"rdi",".Lp434p1(%rip)",map("r$_",(8..13)),"rcx");
  # a[4-5] x .Lp434p1 --> result: r8:r13
  my $mul45=&mul128x256_school(32,"rdi",".Lp434p1(%rip)",map("r$_",(8..13)),"rcx");
  # a[6-7] x .Lp434p1 --> result: r8:r13
  my $mul67=&mul64x256_school(48,"rdi",".Lp434p1(%rip)",map("r$_", (8..13)));

  my $body=<<___;
    .Lrdc_mulx_asm:
    .cfi_startproc
      # sike_fprdc has already pushed r12--15 and rbx by this point. OZAPTF
...
sub mul_mulx {
  # [rsp] <- (AH+AL) x (BH+BL)
  my $mul256_low=&mul256_school(0,"rsp",32,"rsp",0,"rsp",map("r$_",(8..15)),"rbx","rbp");
  # [rcx] <- AL x BL
  my $mul256_albl=&mul256_school(0,"rdi",0,"rsi",0,"rcx",map("r$_",(8..15)),"rbx","rbp");
  # [rcx+64] <- AH x BH
  my $mul192_ahbh=&mul192_school(32,"rdi",32,"rsi",64,"rcx",map("r$_",(8..14)));
